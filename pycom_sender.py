...
from Entities.Sigfox import Sigfox as SigfoxProfile
from Messages.Fragment import Fragment

print("This is the SENDER script for Sigfox Uplink transmissions")

if len(sys.argv) < 3:
	print("python sender.py [FILENAME] [-hv]")
	sys.exit()
...
i = 0
current_window = 0
profile_uplink = SigfoxProfile("UPLINK", "ACK ON ERROR")
profile_downlink = SigfoxProfile("DOWNLINK", "NO ACK")
...
while i < len(fragment_list):
	...
	if fragment.is_all_0() or fragment.is_all_1():
		...
		# Configure for downlink reception
